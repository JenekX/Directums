...
namespace Directums.Client.DirectumsService {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="GetDirsResult", Namespace="http://schemas.datacontract.org/2004/07/Directums.Service.Classes")]
    [System.SerializableAttribute()]
    public partial class GetDirsResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        public int typeAccess {
            ...
            set {
                if ((this.typeAccessField.Equals(value) != true)) {
                    this.typeAccessField = value;
                    this.RaisePropertyChanged("typeAccess");
                }
            }
        }
    ...
    public interface IDirectumsService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDirectumsService/GetDirs", ReplyAction="http://tempuri.org/IDirectumsService/GetDirsResponse")]
        Directums.Client.DirectumsService.GetDirsResult[] GetDirs();
        ...
        Directums.Client.DirectumsService.GetFilesResult[] GetFiles(int dirId);
        ...
        bool AddFile(string name, string ex, int parent, byte[] b);
        ...
        bool AddVersion(int file, byte[] b);
    ...
    public partial class DirectumsServiceClient : System.ServiceModel.DuplexClientBase<Directums.Client.DirectumsService.IDirectumsService>, Directums.Client.DirectumsService.IDirectumsService {
        ...
        public Directums.Client.DirectumsService.GetDirsResult[] GetDirs() {
            return base.Channel.GetDirs();
        }
        
        public Directums.Client.DirectumsService.GetFilesResult[] GetFiles(int dirId) {
            return base.Channel.GetFiles(dirId);
        }
        ...
        public bool AddFile(string name, string ex, int parent, byte[] b) {
            return base.Channel.AddFile(name, ex, parent, b);
        }
        
        public bool AddVersion(int file, byte[] b) {
            return base.Channel.AddVersion(file, b);
        }
